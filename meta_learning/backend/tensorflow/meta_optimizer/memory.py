...
from meta_learning.backend.tensorflow.meta_optimizer import interface as _interface
...
class _MemoryOptimizer(optimizer.Optimizer):
    ...
    def _create_slots(self, var_list):
        ...
        for var in var_list:
            ...
            self._gradient[var.name] = self._base_optimizer_init_fn()
...
class Memory(_interface.Interface):
    ...
    def init_fn(cls,
        ...
        def fn():
            return cls(memory_init_fn=memory_init_fn,
                       base_optimizer_init_fn=base_optimizer_init_fn,
    ...
    def __init__(self,
                 ...
                 params=None,
                 memory_init_fn=None,
                 base_optimizer_init_fn=None):
        super(Memory, self).__init__(
            use_exclude_var_names=use_exclude_var_names)

        if memory_init_fn is None:
            def memory_init_fn_loc():
                return _memory.create_from_params(params)
            memory_init_fn = memory_init_fn_loc

        if base_optimizer_init_fn is None:
            def base_optimizer_init_fn_loc():
                return _base_optimizer.create_from_params(
                    params)
            base_optimizer_init_fn = base_optimizer_init_fn_loc
